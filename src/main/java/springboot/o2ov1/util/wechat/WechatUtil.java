package springboot.o2ov1.util.wechat;
...
public class WechatUtil {
    ...
    public static User getUserFromWeChat(WechatUser wechatUser) {
        User user = new User();
        user.setName(wechatUser.getNickName());
        user.setGender(wechatUser.getSex()==1 ? "男":"女" );
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wxe1df25dad9a4b6e3";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "5cb17d576949c0d1ee865b2f1c8fbc35";
